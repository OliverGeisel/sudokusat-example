...
def main(*args):
    ...
    print("Time to encode to SAT: {time}s".format(time=time_to_encode), file=sys.stderr)
    ...
    print("Time to decode and get Solution SAT: {time}s".format(time=time_to_decode), file=sys.stderr)
